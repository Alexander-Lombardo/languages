// Spanish A1 → C2 — course data root.
...
window.COURSE.levels = [
  ...
  { code: "A2", name: "Elementary",          blurb: "Talk about the past and routines, shop, describe weather and health, express likes." },
  { code: "B1", name: "Intermediate",        blurb: "Use the subjunctive and conditional, narrate, give opinions, handle travel and work." },
  { code: "B2", name: "Upper-Intermediate",  blurb: "Debate, report speech, master perfect tenses and passive, discuss society in detail." },
  { code: "C1", name: "Advanced",            blurb: "Argue with nuance, use idioms and discourse markers, read media and literature." },
...
window.COURSE.outline = [
  ...
  { id: "02", level: "A1", slug: "ser-estar",           title: "Ser vs Estar (to be)" },
  ...
  { id: "08", level: "A1", slug: "tener-irregulars",    title: "Tener & Common Irregular Verbs" },
  { id: "09", level: "A1", slug: "questions-directions", title: "Questions, Directions & Places" },

  { id: "10", level: "A2", slug: "preterite",           title: "The Preterite (Past Simple)" },
  { id: "11", level: "A2", slug: "imperfect",           title: "The Imperfect" },
  { id: "12", level: "A2", slug: "preterite-vs-imperfect", title: "Preterite vs Imperfect" },
  { id: "13", level: "A2", slug: "near-future",         title: "The Near Future (ir a + infinitive)" },
  ...
  { id: "16", level: "A2", slug: "gustar",              title: "Gustar & Similar Verbs" },
  ...
  { id: "20", level: "B1", slug: "subjunctive-intro",   title: "Present Subjunctive: Wishes & Emotions" },
  { id: "21", level: "B1", slug: "por-para",            title: "Por vs Para" },
  { id: "22", level: "B1", slug: "conditional",         title: "The Conditional & Polite Requests" },
  { id: "23", level: "B1", slug: "relative-clauses",    title: "Relative Clauses (que, quien, donde)" },
  { id: "24", level: "B1", slug: "object-pronouns",     title: "Object Pronouns Together" },
  { id: "25", level: "B1", slug: "travel-transport",    title: "Travel & Transport" },
  { id: "26", level: "B1", slug: "work-studies",        title: "Work & Studies" },
  { id: "27", level: "B1", slug: "commands",            title: "Commands (the Imperative)" },
  { id: "28", level: "B1", slug: "narrating",           title: "Narrating a Story" },
  { id: "29", level: "B1", slug: "idioms-connectors",   title: "Idioms & Connectors" },

  { id: "30", level: "B2", slug: "subjunctive-doubt",   title: "The Subjunctive: Doubt & Impersonal" },
  { id: "31", level: "B2", slug: "perfect-tenses",      title: "The Perfect Tenses (he hablado)" },
  { id: "32", level: "B2", slug: "pluperfect",          title: "The Pluperfect (había hablado)" },
  { id: "33", level: "B2", slug: "passive-se",          title: "The Passive & \"se\" Constructions" },
  { id: "34", level: "B2", slug: "reported-speech",     title: "Reported Speech" },
  ...
  { id: "38", level: "B2", slug: "register",            title: "Register: Formal vs Informal" },
  { id: "39", level: "B2", slug: "idiomatic-verbs",     title: "Idiomatic & \"Phrasal\" Verbs" },

  { id: "40", level: "C1", slug: "past-subjunctive",    title: "Imperfect & Pluperfect Subjunctive" },
  { id: "41", level: "C1", slug: "hypotheticals",       title: "Conditional Perfect & Hypotheticals" },
  ...
  { id: "52", level: "C2", slug: "regional-varieties",  title: "Regional Varieties (España vs LatAm)" },
  ...
  { id: "58", level: "C2", slug: "native-pitfalls",     title: "Near-Native Pitfalls" },
